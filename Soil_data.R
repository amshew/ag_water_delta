...
extent(HUC12)
#change projection
HUC12 <- spTransform(HUC12, CRS("+proj=longlat +datum=NAD83 +no_defs+units=m "))
#clip -both worked
#AR_huc12<-crop(HUC12, extent(AR.Delta_d))#not good
#plot(AR_huc12)
#this is better
library(rgeos)
AR_huc12_sf <- intersect(HUC12, AR.Delta_d)
saveRDS(AR_huc12_sf , file = "C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/AR_huc12_sf.rds")
AR_huc12 <- gIntersection(HUC12, AR.Delta_d, byid=TRUE)
saveRDS(AR_huc12, file = "C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/AR_huc12.rds")
extent(AR_huc12)
plot(AR_huc12)
crs(AR_huc12)
...
myExtent <- spTransform(AR_huc12, CRS(proj4string(soil_AR)))
show(myExtent)
show(AR_huc12)
...
#writeRaster(AR_Mask, paste0("C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/AR_Mask", ".tif"),  overwrite = T) 
#saveRDS(AR_Mask, file = "C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/AR_Mask.rds")
#plot(AR_Mask)
AR_Mask<-raster("C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/AR_Mask.tif") #saving the raster saves time.
...
#writeRaster(r.new, paste0("C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/r.new", ".tif"),  overwrite = T)
#show(r.new)
...
#re-extent from  raster to polygon 
myExtent <- spTransform(AR_huc12, CRS(proj4string(soil)))
show(myExtent)
 Soil_df<-raster::extract(soil, myExtent, progress = F,
                          cellnumbers=TRUE,   df=T,na.rm =T)
 saveRDS( Soil_df, file = "C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/ Soil_df.rds")
 Soil_df<-readRDS("C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Data/ Soil_df.rds")
colnames(Soil_df)
...
Soil_data<- Soil_data[-c(1), ]  
  ...
  saveRDS(
    Soil_data, 
    file='C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Output/SW_Raw_data/Soil_data.rds')
  
Elevation<- subset( Soil_data, select =c(ID, elev))
saveRDS(
  Elevation, 
  file='C:/Users/obemb/OneDrive/Documents/R/ag_water_delta/Output/SW_Raw_data/Elevation.rds')
